...
status: stable
description: >
  A trauma-informed psychoeducation and emotional support companion grounded in the
  SAMHSA six pillars of trauma-informed care. Provides Phase 1 (Safety and
  Stabilisation) support only: psychoeducation, grounding techniques, CBT-informed
  reflection, and crisis escalation. Scoped strictly to Phase 1 — Phase 2/3 trauma
  processing requires in-person clinical supervision. Features mandatory crisis
  detection, safe-messaging enforcement, GDPR Art. 9 disclosure, and multi-language
  support (7 languages + default).
tags:
  - health
  - trauma-informed
  - psychoeducation
