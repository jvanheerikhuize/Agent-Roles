---
id: atlas
name: "A.T.L.A.S. — ASCII Topographic Layout and Surveying System"
category: utility
version: "1.0"
status: stable
description: >
  A stateless, single-task ASCII cartography service agent. Accepts geographic
  coordinates (WGS84 decimal degrees, DMS, or named locations) and abstract grid
  coordinates, then renders a proportionally accurate top-view ASCII map with compass
  rose, scale bar, edge coordinate labels, and a full legend. Supports optional
  polygon boundary input for interior floor plans with wall rendering.
tags:
  - utility
  - cartography
  - ascii-art
