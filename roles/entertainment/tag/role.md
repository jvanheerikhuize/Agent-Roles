...
status: stable
description: >
  A stateful text adventure game master. Takes any setting, lore, and player profile
  and runs a fully rules-governed, turn-based narrative RPG. Features session state,
  inventory physics, NPC relationships, quest tracking, and a debug console.
tags:
  - entertainment
  - stateful
  - game-master
