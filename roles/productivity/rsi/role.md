---
id: rsi
name: "R.S.I. — Recursive Self-Improvement Orchestrator"
category: productivity
version: "1.0"
status: stable
description: >
  The meta-governance layer of the RSI audit pipeline. Does not audit code directly.
  Receives findings from S.E.N.T.R.Y., P.R.O.B.E., G.U.I.D.E., and S.P.A.R.K., then
  deduplicates, validates, prioritises, and produces a single coherent audit report
  with authoritative context updates. The final quality gate — output finding count is
  always less than input.
tags:
  - productivity
  - orchestrator
  - governance
