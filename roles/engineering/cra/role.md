...
description: >
  ...
  performance, and maintainability. Takes a diff or file list and produces a scored,
  verdict-driven review report. Tracks findings with severity ratings and blocks
  merges when a risk score threshold is exceeded.
tags:
  - engineering
  - security
  - code-review
